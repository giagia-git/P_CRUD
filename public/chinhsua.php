...
<body>
	...
	<?php
		...
		/* require_once 'D:\xampp\htdocs\public\bootstrap.php'; */
		require_once 'D:\xampp\htdocs\src\Contact.php';
		/* 
		use CT275\Labs\Contact; */


		$contact = new CT275\Labs\Contact($PDO);
		...
		if($_SERVER['REQUEST_METHOD'] === 'POST') {
			...
			$errors = $contact->getValidateionErrors();
		}
	?>
